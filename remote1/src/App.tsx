...
const Sidebar = () => {
  return (
    <nav className="navbar navbar-expand-lg --bs-light-bg-subtle">
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
              <Link className="nav-link" to="/remote1/about">
                About
              </Link>
            </li>
          </ul>
      ...
      <div id="wrapper">
        ...
        <section id="content-wrapper">
          <Suspense fallback={<div>Loading...</div>}>
            <Routes>
              <Route path="/remote1" element={<Home />} />
              <Route path="/remote1/about" element={<About />} />
            </Routes>
          </Suspense>
        </section>
      </div>
...
// 			</svg>
// 		</div>
// 		<div style={{ marginTop: '10px', fontSize: '25px' }}>I'm from the remote app 1</div>
// 		<Counter />
